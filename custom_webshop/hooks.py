...
app_title = "Custom Webshop"
app_publisher = "Kivu Choice"
app_description = "First custom app. Customize products per users warehouse"
app_email = "huwizera@kivuchoice.com"
app_license = "mit"

web_include_js = ["/assets/custom_webshop/js/cart.js?v=2025-05-07"]
